...
class HarshPandey:
    ...
    focus   = [
        "Agentic AI & Graph-Based RAG Systems",
        "End-to-end ML pipelines → production",
        "Scalable MERN + Microservices architecture",
        "NLP · Computer Vision · LLMs"
    ]
    shipped = "34+ projects spanning AI, data & full stack"
...
- **5 decoupled microservices** (Auth, Appointment, Query, Notification, API Gateway)
- JWT auth with refresh tokens + double-booking prevention
- Rate limiting, CI/CD via **GitHub Actions**, containerized with Docker Compose
...
- Graph-based retrieval for **explainable, traceable AI answers**
- Full stack: Python AI service + Node backend + React frontend
- Addresses the **black-box problem** in enterprise LLM deployments
...
![Llama](https://img.shields.io/badge/Llama%2070B%2F8B-7B2FFF?style=flat-square&logo=meta&logoColor=white)
![Gemini](https://img.shields.io/badge/Gemini-4285F4?style=flat-square&logo=google&logoColor=white)

- **3-tier intelligent fallback**: Llama-70B → Llama-8B → Gemini (cost-optimized)
- Gemini Embeddings + ChromaDB vector store for semantic retrieval
- Autonomous end-to-end response generation — zero human intervention
...
![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![YOLO](https://img.shields.io/badge/YOLOv8-00FFAB?style=flat-square&logo=yolo&logoColor=black)
![OpenCV](https://img.shields.io/badge/OpenCV-5C3EE8?style=flat-square&logo=opencv&logoColor=white)
![TTS](https://img.shields.io/badge/OCR--to--Speech-FF6B6B?style=flat-square&logo=google&logoColor=white)

- **Object detection** (YOLO) + **gesture recognition** + **OCR-to-speech** pipeline
- Real-time processing for assistive navigation
- Multimodal AI with a direct human-centered impact
...
![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![LLM](https://img.shields.io/badge/LLM-7B2FFF?style=flat-square&logo=openai&logoColor=white)
...
![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![NLP](https://img.shields.io/badge/NLP-FF6B6B?style=flat-square&logo=huggingface&logoColor=white)
![Multimodal](https://img.shields.io/badge/Multimodal%20AI-00D4FF?style=flat-square&logo=tensorflow&logoColor=white)
...
![YOLO](https://img.shields.io/badge/YOLO-00FFAB?style=for-the-badge&logo=yolo&logoColor=black)
...
![n8n](https://img.shields.io/badge/n8n%20Automation-EF6821?style=for-the-badge&logo=n8n&logoColor=white)
![VAPI](https://img.shields.io/badge/VAPI%20Voice%20AI-7B2FFF?style=for-the-badge&logo=openai&logoColor=white)
...
[![GitHub Streak](https://streak-stats.demolab.com?user=tortejumpy&theme=tokyonight-duo&hide_border=true&background=0d1117&ring=00d4ff&fire=7b2fff&currStreakLabel=00d4ff)](https://git.io/streak-stats)

</div>

<div align="center">

[![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=tortejumpy&theme=tokyo-night&bg_color=0d1117&color=00d4ff&line=7b2fff&point=ffffff&area=true&hide_border=true)](https://github.com/ashutosh00710/github-readme-activity-graph)
...
*Open to AI/ML Engineering, Data Science, Full Stack, and Research roles.*
